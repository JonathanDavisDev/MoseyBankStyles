...
export default function Home() {
  return (
    <>
      <HomeHero heading="All your money in one place." subheading="Your cash, your choices, and a banking experience that's as unique as you are." />
      <ContainerBlock columns={1} marginTop={"extraLarge"} marginBottom={"large"} gap={"none"}>
        <TextBlock center={true} overline="banking made modern" heading="Send, spend and save smarter" description="<p>Change the way you bank.</p>" headingSize={"medium"}></TextBlock>
      </ContainerBlock>
      <ContainerBlock columns={1} marginTop={"medium"} marginBottom={"medium"} gap={"medium"}>
        <CardBlock
          imageLayout="after"
          image={{ src: "https://placekitten.com/660/400", alt: "Kitten", width: 660, height: 400 }}
          color="blue"
          heading="Saving"
      ...
      <ContainerBlock columns={1} marginTop={"extraLarge"} marginBottom={"extraLarge"} gap={"none"}>
        <CardBlock
          imageLayout="after"
          image={{ src: "https://placekitten.com/660/400", alt: "Kitten", width: 660, height: 400 }}
          color="purple"
