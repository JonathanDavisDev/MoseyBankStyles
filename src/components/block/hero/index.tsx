  ...
  return (
    <section className={`outer-padding py-32 lg:py-64 ${additionalClasses.join(" ")}`}>
      <div className={`w-full @container/card container mx-auto`}>
        <div className="w-full h-full grid items-center grid-cols-1 gap-16 @[80rem]/card:grid-cols-12 @[80rem]/card:gap-32">
          <div
            className={`prose lg:prose-h1:text-[72px] lg:prose-h1:my-[48px] prose-h1:font-bold prose-p:text-[24px] prose-p:leading-[30px] prose-img:my-4 @[80rem]/card:col-span-6 ${innerClasses.join(
              " "
            )}`}
          >
